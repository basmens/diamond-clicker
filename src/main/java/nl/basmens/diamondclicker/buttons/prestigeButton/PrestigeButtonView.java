...
public class PrestigeButtonView extends ButtonView {
  
  
  public PrestigeButtonView(View parentView, Rectangle2D.Float frameRect, String id) {
  ...
  public void beforeDrawChildren(PApplet p, float width, float height) {
    ...
    p.text("Prestige", width / 2, height / 2);
  }
}
